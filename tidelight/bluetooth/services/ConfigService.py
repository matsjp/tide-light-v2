...
from bluetooth.characteristics.configcharacteristics.HighTideDirectionColorCharacteristic import \
    HighTideDirectionColorCharacteristic
from bluetooth.characteristics.configcharacteristics.LowTideDirectionColorCharacteristic import \
    LowTideDirectionColorCharacteristic
from bluetooth.characteristics.configcharacteristics.TideLevelIndicatorColorCharacteristic import \
    TideLevelIndicatorColorCharacteristic
from bluetooth.characteristics.configcharacteristics.NoTideLevelIndicatorColorCharacteristic import \
    NoTideLevelIndicatorColorCharacteristic
from bluetooth.characteristics.configcharacteristics.TideLevelIndicatorMovingColorCharacteristic import \
    TideLevelIndicatorMovingColorCharacteristic
from bluetooth.characteristics.configcharacteristics.NoTideLevelIndicatorMovingColorCharacteristic import \
    NoTideLevelIndicatorMovingColorCharacteristic
...
class ConfigService(BlenoPrimaryService):
    ...
    def __init__(self, config):
        self.latLonCharacteristic = LatLonCharacteristic(config)
